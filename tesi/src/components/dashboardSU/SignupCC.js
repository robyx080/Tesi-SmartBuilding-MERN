...
function SignupCC() {
    ...
    const [selectEdificio,setSelect] = useState("");
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:5000/signupCC', {nome,cognome,cf,data,luogo,telefono,email,hash,Chash,selectEdificio});
            ...
            switch (response.data) {
                case "valid entry":
                    ...
                    document.getElementById("formErrCC").style.display="none";
                ...
                case "già capocondomino":
                    document.getElementById("formSuc").style.display="none";
                    document.getElementById("formErr").style.display="none";
                    document.getElementById("formPass").style.display="none";
                    document.getElementById("formEmailOrCf").style.display="none";
                    document.getElementById("formErrCC").style.display="block";
                    setTimeout(()=>{
                        document.getElementById("formErrCC").style.display="none";
                    },10000)
                    break;
            ...
            <div className="p-7 text-2xl font-semibold flex-1 h-full">
                ...
                <main className='form-login text-center' style={{paddingTop:"30px"}}>
                    <form onSubmit={handleSubmit}>
                        ...
                        <select className='form-control' id="selectEdificio" name="selectEdificio" onChange={(e) => setSelect(e.target.value)} value={selectEdificio}></select>
                    ...
                    <div className="alert alert-success" role="alert" style={{ display: "none" }} id="formSuc" >
                        <h6 className="alert-heading">Capo condomino inserito</h6>
                    </div>
                    ...
                    <div className="alert alert-danger" role="alert" style={{ display: "none" }} id="formErrCC" >
                        <h6 className="alert-heading">Edificio già con capocondomino</h6>
                    </div>
                </main>
            </div>
        </div>
